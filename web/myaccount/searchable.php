...
$GENDER_SYMBOLS = array(
    '',
    'female.png', // venus/female
    'male.png', // mars/male
    'trans.png', // binary transgendered
    'trans2.png', // non-binary transgendered
    'asex.png', // asexual/non-gendered
    'female2.png', // gay female
    'male2.png', // gay male
    'love.png', // heart icon
...
if($_POST['action'] == 'updatesearchable')
{
    ...
    if(in_array($_POST['gender'], $GENDER_SYMBOLS))
...
<body>
    ...
    <?php if($general_message): ?>
        <p style="color:blue;"><?= $general_message ?></p>
    <?php endif; ?>
    ...
    <form method="post" id="account" name="account">
        <table>
            ...
            <tr>
                <td class="leftbar" valign="top">Identity:</td>
                <td valign="top">
                    <?php foreach($GENDER_SYMBOLS as $symbol): ?>
                        <input type="radio" name="gender" value="<?= $symbol ?>"<?= ($userprofile['gender'] == $symbol ? ' checked' : '') ?> /><?php if($symbol != ''): ?><img src="//<?= $SETTINGS['static_domain'] ?>/gfx/identity/<?= $symbol ?>" /><?php endif; ?><br />
                    <?php endforeach; ?>
                </td>
                <td valign="top"></td>
            </tr>
